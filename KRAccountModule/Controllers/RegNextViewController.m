...
@interface RegNextViewController ()<UITableViewDelegate, UITableViewDataSource>
@property (nonatomic, strong) UITableView *tableView;
/// 产品数组
@property (nonatomic, strong) NSMutableArray *datas;
@end

@implementation RegNextViewController
...
{
    RegNextTableViewCell *cell  = [_tableView dequeueReusableCellWithIdentifier:CELL_ID];
    cell.phone = self.phone;
    cell.name = self.name;
    cell.verifyCode = self.verifyCode;
    cell.inviteCodeStatus = self.inviteCodeStatus;
    cell.deleagate = self;
...
- (UITableView *)tableView{
    if (_tableView == nil) {
        ...
        [_tableView registerClass:[RegNextTableViewCell class] forCellReuseIdentifier:CELL_ID];
    }
    return _tableView;
}
